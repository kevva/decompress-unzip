...
test('extract file from stream input', async t => {
	const stream = fs.createReadStream(path.join(__dirname, 'fixtures', 'file.zip'));
...
test('return empty array if non-valid file stream is supplied', async t => {
